                ...
                <div className='w-[100%] sm:w-[70%]'>
                    {
                        !showVideo ? (
                            <div className="relative">
                                <img  className='w-full object-cover pb-5 sm:w-2/3'
                                     src={course?.introductory_video} alt=""/>
                                <div className="absolute left-[30%] top-[38%] cursor-pointer " onClick={show}>
                                    <svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="70" height="70" rx="35" fill="white"/>
                                        <path d="M29.375 22.75V47.25L48.625 35L29.375 22.75Z" fill="#1E1E1E"/>
                                    </svg>
                                </div>
                            </div>

                        ) : (
                                loading ? 'loading...' :   <video width="100%" height="auto" autoPlay
